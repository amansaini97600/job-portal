    ...
    <div className="flex min-h-screen">
      ...
      <aside className="w-1/4 bg-blue-900 text-white p-5 space-y-4">
        ...
        <ul className="space-y-2">
          ...
          <li className="hover:text-yellow-400 cursor-pointer"><Link to="/jobs">All Jobs</Link></li>
          <li className="hover:text-yellow-400 cursor-pointer"><Link to="/post-job">Post Job</Link></li>
          <li className="hover:text-yellow-400 cursor-pointer"><Link to="/">Login</Link></li>
          <li className="hover:text-yellow-400 cursor-pointer"><Link to="/">Contact Us</Link></li>
        </ul>
      </aside>
